...
const LayersTooltip = ({ canvas, animation }) => {
...
function addEventsDragAndDrop(el) {
  ...
  el.addEventListener('dragend', dragEnd, false);
    ...
    return (
      <StyleLayersOrder>
        <div className="closing" onClick={() => animation.reverse()}> <HeaderMd>Layers</HeaderMd>  <FiX size={23}/></div>
